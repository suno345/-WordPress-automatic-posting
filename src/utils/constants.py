...
class Constants:
    ...
    SEARCH_LIMIT: Final[int] = 100  # 1回の検索件数（API制限に合わせて100）
    MAX_ADDITIONAL_SEARCHES: Final[int] = 24  # 低レビュー率期間対応：最大2,500件検索可能（100×25回）
    ADDITIONAL_SEARCH_BATCH_SIZE: Final[int] = 100  # 追加検索も100件で統一
