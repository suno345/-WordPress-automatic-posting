...
class ConfigManager:
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        ...
        return {
            'wordpress': {
                'url': self.wordpress.url,
                'username': self.wordpress.username,
                'password_configured': bool(self.wordpress.password)
            },
            'dmm_api': {
                'api_id': SecretSanitizer.mask_api_key(self.dmm_api.api_id),
                'affiliate_id': SecretSanitizer.mask_api_key(self.dmm_api.affiliate_id) if self.dmm_api.affiliate_id else None,
                'configured': bool(self.dmm_api.api_id)
            },
            'gemini': {
